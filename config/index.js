...
const config = Object.freeze({
  ...
  BOT_NAME: env.BOT_NAME || 'MAMA AGI',
  ...
  OPENAI_COMPLETION_PRESENCE_PENALTY: Number(env.OPENAI_COMPLETION_PRESENCE_PENALTY) || 0.8,
  ...
  SERPAPI_LOCATION: env.SERPAPI_LOCATION || 'th',
});
